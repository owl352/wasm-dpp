...
return className;}function takeFromExternrefTable0(idx){const value=wasm.__wbindgen_export_4.get(idx);wasm.__externref_table_dealloc(idx);return value;}/**
 ...
 * @returns {number}
 */function getLatestProtocolVersion(){const ret=wasm.getLatestProtocolVersion();return ret>>>0;}function getArrayJsValueFromWasm0(ptr,len){ptr=ptr>>>0;const mem=getDataViewMemory0();const result=[];for(let i=ptr;i<ptr+4*len;i+=4){result.push(wasm.__wbindgen_export_4.get(mem.getUint32(i,true)));}wasm.__externref_drop_slice(ptr,len);return result;}function passArrayJsValueToWasm0(array,malloc){const ptr=malloc(array.length*4,4)>>>0;const mem=getDataViewMemory0();for(let i=0;i<array.length;i++){mem.setUint32(ptr+4*i,addToExternrefTable0(array[i]),true);}WASM_VECTOR_LEN=array.length;return ptr;}let cachedUint32ArrayMemory0=null;function getUint32ArrayMemory0(){if(cachedUint32ArrayMemory0===null||cachedUint32ArrayMemory0.byteLength===0){cachedUint32ArrayMemory0=new Uint32Array(wasm.memory.buffer);}return cachedUint32ArrayMemory0;}function passArray32ToWasm0(arg,malloc){const ptr=malloc(arg.length*4,4)>>>0;getUint32ArrayMemory0().set(arg,ptr/4);WASM_VECTOR_LEN=arg.length;return ptr;}/**
 ...
 */const StateTransitionTypes=exports.StateTransitionTypes=Object.freeze({DataContractCreate:0,"0":"DataContractCreate",DocumentsBatch:1,"1":"DocumentsBatch",IdentityCreate:2,"2":"IdentityCreate",IdentityTopUp:3,"3":"IdentityTopUp",DataContractUpdate:4,"4":"DataContractUpdate",IdentityUpdate:5,"5":"IdentityUpdate",IdentityCreditWithdrawal:6,"6":"IdentityCreditWithdrawal",IdentityCreditTransfer:7,"7":"IdentityCreditTransfer",MasternodeVote:8,"8":"MasternodeVote"});const AssetLockOutputNotFoundErrorFinalization=typeof FinalizationRegistry==='undefined'?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(ptr=>wasm.__wbg_assetlockoutputnotfounderror_free(ptr>>>0,1));class AssetLockOutputNotFoundError{__destroy_into_raw(){const ptr=this.__wbg_ptr;this.__wbg_ptr=0;AssetLockOutputNotFoundErrorFinalization.unregister(this);return ptr;}free(){const ptr=this.__destroy_into_raw();wasm.__wbg_assetlockoutputnotfounderror_free(ptr,0);}}exports.AssetLockOutputNotFoundError=AssetLockOutputNotFoundError;const AssetLockProofFinalization=typeof FinalizationRegistry==='undefined'?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(ptr=>wasm.__wbg_assetlockproof_free(ptr>>>0,1));class AssetLockProof{__destroy_into_raw(){const ptr=this.__wbg_ptr;this.__wbg_ptr=0;AssetLockProofFinalization.unregister(this);return ptr;}free(){const ptr=this.__destroy_into_raw();wasm.__wbg_assetlockproof_free(ptr,0);}/**
     ...
     * @param {bigint} e
     */setIdentityNonce(e){const ret=wasm.datacontract_setIdentityNonce(this.__wbg_ptr,e);if(ret[1]){throw takeFromExternrefTable0(ret[0]);}}/**
     * @returns {bigint}
     ...
     */setRevision(revision){wasm.document_setRevision(this.__wbg_ptr,isLikeNone(revision)?0x100000001:revision>>>0);}/**
     * @returns {number | undefined}
     */getRevision(){const ret=wasm.document_getRevision(this.__wbg_ptr);return ret===0x100000001?undefined:ret;}/**
     * @param {any} d
     ...
     * @returns {any}
     */getRevision(){const ret=wasm.documenttransition_getRevision(this.__wbg_ptr);return ret;}/**
     ...
     */setRevision(rev){wasm.extendeddocument_setRevision(this.__wbg_ptr,isLikeNone(rev)?0x100000001:rev>>>0);}/**
     * @returns {number | undefined}
     */getRevision(){const ret=wasm.extendeddocument_getRevision(this.__wbg_ptr);return ret===0x100000001?undefined:ret;}/**
     * @param {Uint8Array} e
     ...
     * @param {any} options
     */constructor(options){const ret=wasm.metadata_new(options);if(ret[2]){throw takeFromExternrefTable0(ret[1]);}this.__wbg_ptr=ret[0]>>>0;MetadataFinalization.register(this,this.__wbg_ptr,this);return this;}/**
     * @param {any} object
     * @returns {Metadata}
