...
* @returns {any}
*/function deserializeConsensusError(bytes){try{const retptr=wasm.__wbindgen_add_to_stack_pointer(-16);const ptr0=passArray8ToWasm0(bytes,wasm.__wbindgen_malloc);const len0=WASM_VECTOR_LEN;wasm.deserializeConsensusError(retptr,ptr0,len0);var r0=getInt32Memory0()[retptr/4+0];var r1=getInt32Memory0()[retptr/4+1];var r2=getInt32Memory0()[retptr/4+2];if(r2){throw takeObject(r1);}return takeObject(r0);}finally{wasm.__wbindgen_add_to_stack_pointer(16);}}function __wbg_adapter_1622(arg0,arg1,arg2,arg3){wasm.wasm_bindgen__convert__closures__invoke2_mut__h9005553f76094d10(arg0,arg1,addHeapObject(arg2),addHeapObject(arg3));}/**
