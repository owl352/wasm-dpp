...
state.cnt++;const a=state.a;state.a=0;try{for(var _len=arguments.length,args=new Array(_len),_key=0;_key<_len;_key++){args[_key]=arguments[_key];}return f(a,state.b,...args);}finally{if(--state.cnt===0){wasm.__wbindgen_export_2.get(state.dtor)(a,state.b);}else{state.a=a;}}};real.original=state;return real;}function __wbg_adapter_56(arg0,arg1,arg2){wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hffe408d70b980ad6(arg0,arg1,addHeapObject(arg2));}function passArray8ToWasm0(arg,malloc){const ptr=malloc(arg.length*1)>>>0;getUint8Memory0().set(arg,ptr/1);WASM_VECTOR_LEN=arg.length;return ptr;}function _assertClass(instance,klass){if(!(instance instanceof klass)){throw new Error("expected instance of ".concat(klass.name));}return instance.ptr;}let stack_pointer=128;function addBorrowedObject(obj){if(stack_pointer==1)throw new Error('out of js stack');heap[--stack_pointer]=obj;return stack_pointer;}/**
* @returns {number}
*/function getLatestProtocolVersion(){const ret=wasm.getLatestProtocolVersion();return ret>>>0;}function getArrayU8FromWasm0(ptr,len){ptr=ptr>>>0;return getUint8Memory0().subarray(ptr/1,ptr/1+len);}let cachedUint32Memory0=null;function getUint32Memory0(){if(cachedUint32Memory0===null||cachedUint32Memory0.byteLength===0){cachedUint32Memory0=new Uint32Array(wasm.memory.buffer);}return cachedUint32Memory0;}function getArrayJsValueFromWasm0(ptr,len){ptr=ptr>>>0;const mem=getUint32Memory0();const slice=mem.subarray(ptr/4,ptr/4+len);const result=[];for(let i=0;i<slice.length;i++){result.push(takeObject(slice[i]));}return result;}function passArrayJsValueToWasm0(array,malloc){const ptr=malloc(array.length*4)>>>0;const mem=getUint32Memory0();for(let i=0;i<array.length;i++){mem[ptr/4+i]=addHeapObject(array[i]);}WASM_VECTOR_LEN=array.length;return ptr;}function passArray32ToWasm0(arg,malloc){const ptr=malloc(arg.length*4)>>>0;getUint32Memory0().set(arg,ptr/4);WASM_VECTOR_LEN=arg.length;return ptr;}/**
* @param {any} raw_parameters
* @returns {any}
*/function createAssetLockProofInstance(raw_parameters){try{const retptr=wasm.__wbindgen_add_to_stack_pointer(-16);wasm.createAssetLockProofInstance(retptr,addHeapObject(raw_parameters));var r0=getInt32Memory0()[retptr/4+0];var r1=getInt32Memory0()[retptr/4+1];var r2=getInt32Memory0()[retptr/4+2];if(r2){throw takeObject(r1);}return takeObject(r0);}finally{wasm.__wbindgen_add_to_stack_pointer(16);}}/**
* @param {any} contract_id
* @param {any} owner_id
* @param {string} document_type
* @param {Uint8Array} entropy
* @returns {any}
*/function generateDocumentId(contract_id,owner_id,document_type,entropy){try{const retptr=wasm.__wbindgen_add_to_stack_pointer(-16);const ptr0=passStringToWasm0(document_type,wasm.__wbindgen_malloc,wasm.__wbindgen_realloc);const len0=WASM_VECTOR_LEN;const ptr1=passArray8ToWasm0(entropy,wasm.__wbindgen_malloc);const len1=WASM_VECTOR_LEN;wasm.generateDocumentId(retptr,addBorrowedObject(contract_id),addBorrowedObject(owner_id),ptr0,len0,ptr1,len1);var r0=getInt32Memory0()[retptr/4+0];var r1=getInt32Memory0()[retptr/4+1];var r2=getInt32Memory0()[retptr/4+2];if(r2){throw takeObject(r1);}return takeObject(r0);}finally{wasm.__wbindgen_add_to_stack_pointer(16);heap[stack_pointer++]=undefined;heap[stack_pointer++]=undefined;}}function handleError(f,args){try{return f.apply(this,args);}catch(e){wasm.__wbindgen_exn_store(addHeapObject(e));}}/**
* @param {Uint8Array} bytes
* @returns {any}
*/function deserializeConsensusError(bytes){try{const retptr=wasm.__wbindgen_add_to_stack_pointer(-16);const ptr0=passArray8ToWasm0(bytes,wasm.__wbindgen_malloc);const len0=WASM_VECTOR_LEN;wasm.deserializeConsensusError(retptr,ptr0,len0);var r0=getInt32Memory0()[retptr/4+0];var r1=getInt32Memory0()[retptr/4+1];var r2=getInt32Memory0()[retptr/4+2];if(r2){throw takeObject(r1);}return takeObject(r0);}finally{wasm.__wbindgen_add_to_stack_pointer(16);}}function __wbg_adapter_1623(arg0,arg1,arg2,arg3){wasm.wasm_bindgen__convert__closures__invoke2_mut__h9005553f76094d10(arg0,arg1,addHeapObject(arg2),addHeapObject(arg3));}/**
...
*/exports.IdentityCreditTransferToSelfError=IdentityCreditTransferToSelfError;class IdentityCreditTransferTransition{static __wrap(ptr){ptr=ptr>>>0;const obj=Object.create(IdentityCreditTransferTransition.prototype);obj.__wbg_ptr=ptr;return obj;}__destroy_into_raw(){const ptr=this.__wbg_ptr;this.__wbg_ptr=0;return ptr;}free(){const ptr=this.__destroy_into_raw();wasm.__wbg_identitycredittransfertransition_free(ptr);}/**
    ...
    * @returns {bigint}
    */getIdentityContractNonce(){const ret=wasm.identitycredittransfertransition_getIdentityContractNonce(this.__wbg_ptr);return BigInt.asUintN(64,ret);}/**
    * @param {bigint} identity_nonce
    */setIdentityContractNonce(identity_nonce){wasm.identitycredittransfertransition_setIdentityContractNonce(this.__wbg_ptr,identity_nonce);}/**
    * @param {any} options
    * @returns {any}
...
*/exports.IdentityCreditTransferTransition=IdentityCreditTransferTransition;class IdentityCreditWithdrawalTransition{static __wrap(ptr){ptr=ptr>>>0;const obj=Object.create(IdentityCreditWithdrawalTransition.prototype);obj.__wbg_ptr=ptr;return obj;}__destroy_into_raw(){const ptr=this.__wbg_ptr;this.__wbg_ptr=0;return ptr;}free(){const ptr=this.__destroy_into_raw();wasm.__wbg_identitycreditwithdrawaltransition_free(ptr);}/**
    ...
    * @returns {bigint}
    */getIdentityContractNonce(){const ret=wasm.identitycreditwithdrawaltransition_getIdentityContractNonce(this.__wbg_ptr);return BigInt.asUintN(64,ret);}/**
    * @param {bigint} identity_nonce
    */setIdentityContractNonce(identity_nonce){wasm.identitycreditwithdrawaltransition_setIdentityContractNonce(this.__wbg_ptr,identity_nonce);}/**
    * @param {any} options
    * @returns {any}
...
*/exports.MasternodeVoteAlreadyPresentError=MasternodeVoteAlreadyPresentError;class MasternodeVoteTransition{static __wrap(ptr){ptr=ptr>>>0;const obj=Object.create(MasternodeVoteTransition.prototype);obj.__wbg_ptr=ptr;return obj;}__destroy_into_raw(){const ptr=this.__wbg_ptr;this.__wbg_ptr=0;return ptr;}free(){const ptr=this.__destroy_into_raw();wasm.__wbg_masternodevotetransition_free(ptr);}/**
    ...
    * @returns {number}
    */getSignaturePublicKeyId(){const ret=wasm.masternodevotetransition_getSignaturePublicKeyId(this.__wbg_ptr);return ret>>>0;}/**
    * @param {IdentityPublicKey} identity_public_key
    * @param {Uint8Array} private_key
    * @param {any} bls
