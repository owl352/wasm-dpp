...
export interface InitOutput {
  ...
  readonly documentsbatchtransition_setIdentityContractNonce: (a: number, b: bigint) => void;
  ...
  readonly closure2665_externref_shim: (a: number, b: number, c: any, d: any) => void;
